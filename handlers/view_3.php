    ...
    <div class="mb-4">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <label class="card card-body option-label h-100" for="q<?php echo $q['id']; ?>_a">
                    <?php echo htmlspecialchars($q['a']['text']); ?>
                </label>
            </div>
            <div class="col-md-6">
                <input type="radio" class="btn-check" name="q_<?php echo $q['id']; ?>" id="q<?php echo $q['id']; ?>_b" value="b" required>
                <label class="card card-body option-label h-100" for="q<?php echo $q['id']; ?>_b">
